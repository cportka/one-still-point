...
<filter id="a-dustglow" x="-300%" y="-300%" width="700%" height="700%"><feGaussianBlur stdDeviation="5"></feGaussianBlur></filter>
...
<g class="a-dust" fill="#e9e3d5" visibility="hidden">
<g filter="url(#a-dustglow)" opacity=".5">
<circle class="a-m" r="11"></circle>
<circle class="a-m a-d2" r="8.5"></circle>
<circle class="a-m a-d3" r="7"></circle>
</g>
<g filter="url(#a-soft)">
<circle class="a-m" r="7"></circle>
<circle class="a-m a-d2" r="5.2"></circle>
<circle class="a-m a-d3" r="4"></circle>
</g>
</g>
